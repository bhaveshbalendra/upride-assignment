...
import PhotoGallary from "./ui/photo-gallary";
...
const StorySection = () => {
  return (
    <div className="min-h-[63.74rem] bg-[#F2EAEA] relative ">
      <PhotoGallary />
      <div className="flex max-w-[107.402rem] mx-auto gap-[9rem] ">
        <div className="flex flex-col pt-[15.296rem]">
          <h3
          ...
          <h2
            className={`${anybody.variable} font-anybody text-[#151515] text-[2.75rem] leading-[127.273%] font-bold`}
          >
            Milestones that Define our Success
          </h2>
        </div>
        <p
          className={`${arimo.variable} font-armio pt-[15.546rem] text-[1.375rem] font-normal leading-[157%] p-[0.625rem] max-w-[64.715rem]`}
        >
      ...
      <div className=" max-w-[107.402rem] mx-auto flex gap-[9.605rem] pt-[6.671rem]">
